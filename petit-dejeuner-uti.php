...
if (isset($_POST['search'])) {
    ...
    $stmt = $pdo->prepare("SELECT n.*, c.Nom_de_categorie FROM nourritures n INNER JOIN categories c ON n.id_categorie = c.id_categorie WHERE n.id_categorie = 1 LIMIT :offset, :itemsPerPage");
    ...
    // Count total items
    $stmt = $pdo->prepare("SELECT COUNT(*) as total FROM nourritures WHERE id_categorie = 1");
    $stmt->execute();
...
<head>
    ...
    <link rel="stylesheet" href="petit-dejeuner-uti.css">
