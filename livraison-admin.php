...
// Requête SQL avec pagination, recherche et tri
$sql .= " ORDER BY c.Date_de_commande DESC LIMIT :limit OFFSET :offset";
...
<head>
    ...
    <link rel="stylesheet" href="livraison-admin.css">
    ...
    <?php else : ?>
        <?php foreach ($commandes as $commande) : ?>
            <section id="commande-<?php echo $commande['Id_commande']; ?>">
                ...
                <div class="status">
                    <form action="includes/modifier-livraison.inc.php" method="POST">
                        <input type="hidden" name="commande_id" value="<?php echo $commande['Id_commande']; ?>">
                        <div class="select-wrapper">
                            <select name="status" class="custom-select">
                                <option value="<?php echo $commande['Status']; ?>"><?php echo $commande['Status']; ?></option>
