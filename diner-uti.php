...
if (isset($_POST['search'])) {
    ...
    $stmt = $pdo->prepare("SELECT n.*, c.Nom_de_categorie FROM nourritures n INNER JOIN categories c ON n.id_categorie = c.id_categorie WHERE n.id_categorie = 4 LIMIT :offset, :itemsPerPage");
    ...
    // Count total items
    $stmt = $pdo->prepare("SELECT COUNT(*) as total FROM nourritures WHERE id_categorie = 4");
    $stmt->execute();
...
<head>
    ...
    <link rel="stylesheet" href="diner-uti.css">
    <title>Diner</title>
</head>
<body>
